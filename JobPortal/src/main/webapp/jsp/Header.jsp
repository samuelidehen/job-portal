...
<%
    ...
    String welcomeMsg = "Welcome to the best placement agency in montreal, ";
...
%>
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color:#3aadff ">
        <a class="navbar-brand" href="<%=JPView.WELCOME_CTL%>">MyJobOnline</a>
